...
{
    public class BoxColliderBehaviour : PlayableBehaviour
    {
        public GameObject gameObject = null;
        public static ScriptPlayable<BoxColliderBehaviour> Create(PlayableGraph graph, GameObject gameObject)
        {
            var handle = ScriptPlayable<BoxColliderBehaviour>.Create(graph);
