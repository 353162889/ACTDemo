...
namespace Framework
{
    ...
    public class BTAndCondition : BTCondition<IBTContext, BTAndConditionData>
    {
        protected override bool Evaluate(IBTContext context, BTData btData, BTAndConditionData data)
        {
